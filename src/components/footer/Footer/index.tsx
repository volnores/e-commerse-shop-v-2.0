...
const Index: React.FC = () => {
  return (
    <div className="flex mt-8 flex-col md:flex-row justify-between bg-blue-400 bg-opacity-40 p-4 md:p-8 max-w-[1300px] mx-auto  text-black dark:bg-gray-800 dark:text-white">
