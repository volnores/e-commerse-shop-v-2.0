...
const index: React.FC = () => {
 ...
 <div className='flex justify-between bg-blue-400 bg-opacity-40 md: mt-8 max-w-[1900px] mx-auto'>
    ...
    <ul className='flex mt-4 gap-3'>
      <li className=' bg-white rounded-full flex px-4 py-4 cursor-pointer hover:bg-gray-200'>{<GoogleOutlined/>}</li>
      <li className=' bg-white rounded-full flex px-4 py-4 cursor-pointer hover:bg-gray-200'>{<GithubOutlined/>}</li>
      <li className=' bg-white rounded-full flex px-4 py-4 cursor-pointer hover:bg-gray-200'>{<InstagramOutlined/>}</li>
      <li className=' bg-white rounded-full flex px-4 py-4 cursor-pointer hover:bg-gray-200'>{<YoutubeOutlined/>}</li>
      <li className=' bg-white rounded-full flex px-4 py-4 cursor-pointer hover:bg-gray-200'>{<XOutlined/>}</li>
      </ul>
