...
const Categories: React.FC = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-between gap-12 hover:scale-110 transition-all" onClick={() => navigate('/products')}>
    ...
    <div className="text-3xl font-semibold" >Mobile</div>
      ...
      <li className="bg-yellow-200 col-span-2 row-span-1  min-h-[50px] rounded-sm cursor-pointer flex items-center justify-center">
        <div className="flex gap-24 items-center hover:scale-110 transition-all" onClick={() => navigate('/products')}>
      ...
      <li className="bg-green-200 col-span-2 row-span-2 min-h-[50px] px-24 py-8 rounded-sm cursor-pointer  ">
        <div className="flex items-center justify-center gap-24 hover:scale-110 transition-all" onClick={() => navigate('/products')}>
      ...
      <div className="flex flex-col items-center gap-12 mt-12 hover:scale-110 transition-all" onClick={() => navigate('/products')}>
      ...
      <li className="bg-purple-200  min-h-[50px] px-16 py-16 rounded-sm cursor-pointer ">
       <div className="flex flex-col items-center hover:scale-110 transition-all" onClick={() => navigate('/products')}>
       <img src={tv} alt="tv"/>
